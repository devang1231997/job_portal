                                    ...
                                    <div className="profile-info">
                                        ...
                                        <div className="profile-details">
                                            ...
                                            <div className="dropdown ms-auto">
                                                <a href="#" className="btn btn-primary light sharp" data-bs-toggle="dropdown" aria-expanded="true"><svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
                                                ...
                                                <ul className="dropdown-menu dropdown-menu-end">
                                                    <li className="dropdown-item"><i
                                                        className="fa fa-user-circle text-primary me-2"></i> View profile
                                                    </li>
                                                    <li className="dropdown-item"><i className="fa fa-users text-primary me-2"></i>
                                                        Add to btn-close friends</li>
                                                    <li className="dropdown-item"><i className="fa fa-plus text-primary me-2"></i>
                                                        Add to group</li>
                                                    <li className="dropdown-item"><i className="fa fa-ban text-primary me-2"></i>
                                                        Block</li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    <div className="mt-4">
                                                        <a href="javascript:void(0);"
                                                            className="btn btn-primary mb-1 me-1">Follow</a>
                                                                ...
                                                                <form className="comment-form">
                                                                    <div className="row">
                                                                        <div className="col-lg-6">
                                                                            <div className="mb-3">
                                                                                <label
                                                                                    className="text-black font-w600 form-label">Name
                                                                        ...
                                                                        <div className="col-lg-6">
                                                                            <div className="mb-3">
                                                                                <label
                                                                                    className="text-black font-w600 form-label">Email
                                                                                    <span className="required">*</span></label>
                                                                                <input type="text" className="form-control"
                                                                        ...
                                                                        <div className="col-lg-12">
                                                                            <div className="mb-3">
                                                                                <label
                                                                                    className="text-black font-w600 form-label">Comment</label>
                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            <div className="profile-blog">
                                                ...
                                                <h4><a href="post-details.html" className="text-black">Darwin Creative Agency
                                                    Theme</a></h4>
                                                <p className="mb-0">A small river named Duden flows by their place and supplies
                                            ...
                                            <div className="profile-news">
                                                ...
                                                <div className="media pt-3 pb-3">
                                                    ...
                                                    <div className="media-body">
                                                        <h5 className="m-b-5"><a href="post-details.html"
                                                            className="text-black">Collection of textile samples</a></h5>
                                                        <p className="mb-0">I shared this on my fb wall a few months back, and I
                                                            thought.</p>
                                                    </div>
                                                </div>
                                                <div className="media pt-3 pb-3">
                                    ...
                                    <div className="profile-tab">
                                        <div className="custom-tab-1">
                                            <ul className="nav nav-tabs">
                                                <li className="nav-item"><a href="#my-posts" data-bs-toggle="tab"
                                                    className="nav-link active show">Posts</a>
                                                </li>
                                                <li className="nav-item"><a href="#about-me" data-bs-toggle="tab"
                                                    className="nav-link">About Me</a>
                                                </li>
                                                <li className="nav-item"><a href="#profile-settings" data-bs-toggle="tab"
                                                    className="nav-link">Setting</a>
                                                </li>
                                            </ul>
                                                    ...
                                                    <div className="my-post-content pt-3">
                                                        <div className="post-input">
                                                            ...
                                                            <div className="modal fade" id="linkModal">
                                                                <div className="modal-dialog modal-dialog-centered"
                                                                    ...
                                                                    <div className="modal-content">
                                                                        ...
                                                                        <div className="modal-body">
                                                                            <a className="btn-social facebook"
                                                                                href="javascript:void(0)"><i
                                                                                    className="fab fa-facebook-f"></i></a>
                                                                            <a className="btn-social google-plus"
                                                                                href="javascript:void(0)"><i
                                                                                    className="fab fa-google-plus-g"></i></a>
                                                                            <a className="btn-social linkedin"
                                                                                href="javascript:void(0)"><i
                                                                                    className="fab fa-linkedin-in"></i></a>
                                                                            <a className="btn-social instagram"
                                                                                href="javascript:void(0)"><i
                                                                                    className="fab fa-instagram"></i></a>
                                                                            <a className="btn-social twitter"
                                                                                href="javascript:void(0)"><i
                                                                                    className="fab fa-twitter"></i></a>
                                                                            <a className="btn-social youtube"
                                                                                href="javascript:void(0)"><i
                                                                                    className="fab fa-youtube"></i></a>
                                                                            <a className="btn-social whatsapp"
                                                                                href="javascript:void(0)"><i
                                                            ...
                                                            <a href="javascript:void(0);"
                                                                ...
                                                                data-bs-toggle="modal" data-bs-target="#cameraModal"><i
                                                                    className="fa fa-camera m-0"></i> </a>
                                                            {/* <!-- Modal --> */}
                                                        ...
                                                        <div className="profile-uoloaded-post border-bottom-1 pb-5">
                                                            ...
                                                            <a className="post-title" href="post-details.html">
                                                                <h3 className="text-black">Collection of textile samples lay
                                                                    spread</h3>
                                                            </a>
                                                            ...
                                                            <button className="btn btn-secondary" data-bs-toggle="modal"
                                                                data-bs-target="#replyModal"><span className="me-2"><i
                                                                    className="fa fa-reply"></i></span>Reply</button>
                                                        </div>
                                                        <div className="profile-uoloaded-post border-bottom-1 pb-5">
                                                            <img src="/images/profile/9.jpg" alt="" className="img-fluid w-100 rounded" />
                                                            <a className="post-title" href="post-details.html">
                                                                <h3 className="text-black">Collection of textile samples lay
                                                                    spread</h3>
                                                            </a>
                                                ...
                                                <div id="about-me" className="tab-pane fade">
                                                    <div className="profile-about-me">
                                                        <div className="pt-4 border-bottom-1 pb-3">
                                                            ...
                                                            <p className="mb-2">A wonderful serenity has taken possession of my
                                                    ...
                                                    <div className="profile-skills mb-5">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            className="btn btn-primary light btn-xs mb-1">Admin</a>
                                                        <a href="javascript:void(0);"
                                                            className="btn btn-primary light btn-xs mb-1">Dashboard</a>
                                                        <a href="javascript:void(0);"
                                                            className="btn btn-primary light btn-xs mb-1">Photoshop</a>
                                                        <a href="javascript:void(0);"
                                                            className="btn btn-primary light btn-xs mb-1">Bootstrap</a>
                                                        <a href="javascript:void(0);"
                                                            className="btn btn-primary light btn-xs mb-1">Responsive</a>
                                                        <a href="javascript:void(0);"
                                                            className="btn btn-primary light btn-xs mb-1">Crypto</a>
                                                    </div>
                                                    <div className="profile-lang  mb-5">
                                                        <h4 className="text-primary mb-2">Language</h4>
                                                        <a href="javascript:void(0);" className="text-muted pe-3 f-s-16"><i
                                                            className="flag-icon flag-icon-us"></i> English</a>
                                                        <a href="javascript:void(0);" className="text-muted pe-3 f-s-16"><i
                                                            className="flag-icon flag-icon-fr"></i> French</a>
                                                        <a href="javascript:void(0);" className="text-muted pe-3 f-s-16"><i
                                                            className="flag-icon flag-icon-bd"></i> Bangla</a>
                                                    </div>
                                                    <div className="profile-personal-info">
                                                        ...
                                                        <div className="row mb-2">
                                                            ...
                                                            <div className="col-sm-9 col-7"><span>Mitchell C.Shay</span>
                                                            </div>
                                                        </div>
                                                        <div className="row mb-2">
                                                            <div className="col-sm-3 col-5">
                                                            ...
                                                            <div className="col-sm-9 col-7"><span>example@examplel.com</span>
                                                            </div>
                                                        </div>
                                                        <div className="row mb-2">
                                                            <div className="col-sm-3 col-5">
                                                                <h5 className="f-w-500">Availability <span
                                                                    className="pull-end">:</span></h5>
                                                            </div>
                                                            <div className="col-sm-9 col-7"><span>Full Time (Free Lancer)</span>
                                                            </div>
                                                        </div>
                                                        <div className="row mb-2">
                                                            <div className="col-sm-3 col-5">
                                                        ...
                                                        <div className="row mb-2">
                                                            <div className="col-sm-3 col-5">
                                                                <h5 className="f-w-500">Year Experience <span
                                                                    className="pull-end">:</span></h5>
                                                            </div>
