                                ...
                                <div className="card-body">
                                    <div className="media align-items-center">
                                        ...
                                        <div className="media-body text-end feature-icon-text">
                                            <p className="fs-18 text-white mb-2">Interviews</p>
                                            <span className="fs-48 text-white font-w600">86</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card bg-info overflow-hidden">
                                <div className="card-body">
                                    <div className="media align-items-center">
                                        ...
                                        <div className="media-body text-end feature-icon-text">
                                            <p className="fs-18 text-white mb-2">Apply</p>
                                            <span className="fs-48 text-white font-w600">75</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card bg-success">
                                <div className="card-body">
                                    <div className="media align-items-center">
                                        ...
                                        <div className="media-body text-end feature-icon-text">
                                            <p className="fs-18 text-white mb-2">Profile</p>
                                            <span className="fs-48 text-white font-w600">45</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card bg-secondary">
                                <div className="card-body">
                                    <div className="media align-items-center">
                                        ...
                                        <div className="media-body text-end feature-icon-text">
                                            <p className="fs-18 text-white mb-2">Message</p>
                                    ...
                                    <div className="card d-flex flex-xl-column flex-sm-column flex-md-row flex-column">
                                        <div className="card-body text-center profile-bx">
                                            <div className="profile-image mb-4">
                                                <img src={require('../images/avatar/1.jpg')} class="rounded-circle"></img>
                                                {/* <img src={require('../')}></img> */}
                                            </div>
                                            ...
                                            <div className="row">
                                                <div className="col-4 p-0">
                                                    <div className="d-inline-block mb-2 relative donut-chart-sale">
                                                        ...
                                                        <svg class="peity" height="75" width="75"><path d="M 37.5 0 A 37.5 37.5 0 1 1 0.5697092620421955 30.988193337490124 L 10.910190668670381 32.81149920299289 A 27 27 0 1 0 37.5 10.5" data-value="7" fill="rgb(255, 142, 38)"></path><path d="M 0.5697092620421955 30.988193337490124 A 37.5 37.5 0 0 1 37.49999999999999 0 L 37.49999999999999 10.5 A 27 27 0 0 0 10.910190668670381 32.81149920299289" data-value="2" fill="rgba(236, 236, 236, 1)"></path></svg>
                                                ...
                                                <div className="col-4 p-0">
                                                    <div className="d-inline-block mb-2 relative donut-chart-sale">
                                                        ...
                                                        <svg class="peity" height="75" width="75"><path d="M 37.5 0 A 37.5 37.5 0 0 1 50.32575537471258 72.73847327947156 L 46.73454386979306 62.87170076121953 A 27 27 0 0 0 37.5 10.5" data-value="4" fill="rgb(62, 168, 52)"></path><path d="M 50.32575537471258 72.73847327947156 A 37.5 37.5 0 1 1 37.49999999999999 0 L 37.49999999999999 10.5 A 27 27 0 1 0 46.73454386979306 62.87170076121953" data-value="5" fill="rgba(236, 236, 236, 1)"></path></svg>
                                                ...
                                                <div className="col-4 p-0">
                                                    <div className="d-inline-block mb-2 relative donut-chart-sale">
                                                        ...
                                                        <svg class="peity" height="75" width="75"><path d="M 37.5 0 A 37.5 37.5 0 0 1 74.43029073795779 30.98819333749011 L 64.08980933132962 32.81149920299288 A 27 27 0 0 0 37.5 10.5" data-value="2" fill="rgb(34, 172, 147)"></path><path d="M 74.43029073795779 30.98819333749011 A 37.5 37.5 0 1 1 37.49999999999999 0 L 37.49999999999999 10.5 A 27 27 0 1 0 64.08980933132962 32.81149920299288" data-value="7" fill="rgba(236, 236, 236, 1)"></path></svg>
                                        ...
                                        <div className="card-body col-xl-12 col-md-6 col-sm-12 activity-card">
                                            ...
                                            <div className="media mb-4">
                                                <span className="p-3 border me-3 rounded">
                                                    <svg className="primary-icon" width="24" height="24" viewBox="0 0 24 24"
                                                ...
                                                <div className="media-body">
                                                    <p className="fs-14 mb-1 text-black font-w500">Your application has accepted
                                                        in <strong>3 Vacancy</strong></p>
                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="card">
                                        <div className="card-header border-0 pb-0 flex-wrap">
                                            ...
                                            <div className="form-check custom-checkbox mb-3">
                                                <input type="checkbox" className="form-check-input" id="customCheckBox1"
                                                    required />
                                                <label className="form-check-label" for="customCheckBox1">Application
                                                    Sent</label>
                                            </div>
                                            <div className="form-check custom-checkbox mb-3">
                                                <input type="checkbox" className="form-check-input" id="customCheck1" required />
                                                <label className="form-check-label" for="customCheck1">Interviews</label>
                                            </div>
                                            <div className="form-check custom-checkbox mb-3">
                                                <input type="checkbox" className="form-check-input" id="customCheck2" required />
                                                <label className="form-check-label" for="customCheck2">Rejected</label>
                                            </div>
                                        ...
                                        <div className="card-body">
                                        <canvas id="lineChart" class="Vacancy-chart chartjs-render-monitor" style={{display: "block", height: "352px" ,width: "705px"}} width="881" height="440"></canvas>
                                            <div className="d-flex flex-wrap align-items-center justify-content-center mt-3">
                                                <div className="fs-14 text-black me-4">
                                                    <svg className="me-2" width="19" height="19" viewBox="0 0 19 19" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="card shadow">
                                                <div className="card-body">
                                                    <div className="media mb-2">
                                                        ...
                                                        <svg className="ms-3" width="60" height="60" viewBox="0 0 60 60"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                    ...
                                                    <span className="text-primary font-w500 d-block mb-3">$14,000 -
                                                        $25,000</span>
                                                    <p className="fs-14">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        ...
                                        <div className="items">
                                            <div className="card shadow">
                                                <div className="card-body">
                                                    ...
                                                    <div className="d-flex align-items-center mt-4">
                                                        <a href="companies.html"
                                                            className="btn btn-primary light btn-rounded me-auto">FULTIME</a>
                                                        <span className="text-black font-w500 ps-3">London, England</span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="col-xl-12">
                            <div className="d-sm-flex align-items-center mb-3 mt-sm-0 mt-2">
                                ...
                                <a href="companies.html" className="btn btn-primary light btn-rounded">View More
                                    <svg className="ms-3" width="24" height="14" viewBox="0 0 24 14" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
