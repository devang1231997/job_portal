                                ...
                                <div className="col-xl-12">
                                    <div className="card profile-card">
                                        <div className="card-header flex-wrap border-0 pb-0">
                                            <h3 className="fs-24 text-black font-w600 me-auto mb-2 pe-3">Edit Profile</h3>
                                                ...
                                                <div className="d-flex me-5 align-items-center">
                                                    <div className="form-check custom-checkbox">
                                                        <input type="checkbox" className="form-check-input" id="customCheckBox1" required/>
                                                            <label className="form-check-label" for="customCheckBox1">Available for hire?</label>
                                                    </div>
                                                </div>
                                                <a href="#" className="btn btn-dark light btn-rounded me-3 mb-2">Cancel</a>
                                        ...
                                        <div className="card-body">
                                            <form>
                                                    ...
                                                    <div className="row">
                                                            ...
                                                            <div className="form-group">
                                                                ...
                                                                <div className="input-group input-icon mb-3">
                                                                    <div className="input-group-prepend">
                                                                        <span className="input-group-text" id="basic-addon1"><i className="fa fa-phone" aria-hidden="true"></i></span>
                                                                    </div>
                                                        ...
                                                        <div className="col-xl-4 col-sm-6">
                                                            <div className="form-group">
                                                                ...
                                                                <div className="input-group input-icon mb-3">
                                                                    <div className="input-group-prepend">
                                                                        <span className="input-group-text" id="basic-addon2"><i className="fab fa-whatsapp" aria-hidden="true"></i></span>
                                                                    </div>
                                                                    <input type="text" className="form-control" placeholder="Phone no."/>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="col-xl-4 col-sm-6">
                                                            <div className="form-group">
                                                                ...
                                                                <div className="input-group input-icon mb-3">
                                                                    <div className="input-group-prepend">
                                                                        <span className="input-group-text" id="basic-addon3"><i className="las la-envelope"></i></span>
                                                                    </div>
                                                ...
                                                <div>
                                                    <div className="title mb-4"><span className="fs-18 text-black font-w600">Skils</span></div>
                                                    <div className="row">
                                                        <div className="col-xl-6">
                                                            <div className="media mb-4">
                                                                <span className="text-primary progress-icon me-3">78%</span>
                                                        ...
                                                        <div className="col-xl-6">
                                                            <div className="media mb-4">
                                                                <span className="text-primary progress-icon me-3">65%</span>
                                                                <div className="media-body">
                                                        ...
                                                        <div className="col-xl-6">
                                                            <div className="media mb-4">
                                                                <span className="text-primary progress-icon me-3">89%</span>
                                                                <div className="media-body">
                                                                    <p className="font-w500">UI Design</p>
                                                                    <div className="progress skill-progress" style={{height:"10px;"}}>
                                                                        <div className="progress-bar bg-primary progress-animated" style={{width: "89%;", height:"10px;"}} role="progressbar">
                                                        ...
                                                        <div className="col-xl-6">
                                                            <div className="media mb-4">
                                                                <span className="text-primary progress-icon me-3">94%</span>
                                                                <div className="media-body">
                                                                    <p className="font-w500">Researching</p>
                                                                    <div className="progress skill-progress" style={{height:"10px;"}}>
                                                                        <div className="progress-bar bg-primary progress-animated" style={{width: "94%;", height:"10px;"}} role="progressbar">
                                ...
                                <div className="col-xl-12 col-lg-6">
                                    <div className="card  flex-lg-column flex-md-row ">
                                        <div className="card-body card-body  text-center border-bottom profile-bx">
                                            <div className="profile-image mb-4 profilepic">
                                                {/* <img src=".../public/images/avatar/1.jpg" className="rounded-circle" alt=""/> */}
                                                {/* <img src={require("../public/images/avatar/1.jpg")}/> */}
                                                <img src={require('../images/avatar/1.jpg')}className="rounded-circle"></img>
                                            </div>
                                        ...
                                        <div className="card-body  activity-card">
                                            <div className="d-flex mb-3 align-items-center">
                                                <a className="contact-icon me-3" href="#"><i className="fa fa-phone" aria-hidden="true"></i></a>
                                                <span className="text-black">+50 123 456 7890</span>
                                            </div>
                                            <div className="d-flex mb-3 align-items-center">
                                                <a className="contact-icon me-3" href="#"><i className="las la-envelope"></i></a>
                                    ...
                                    <div className="card">
                                        <div className="card-header border-0 pb-0">
                                            ...
                                            <div className="dropdown float-right custom-dropdown mb-0">
                                                <div className="" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                                        ...
                                        <div className="card-body portfolios-card">
                                            <div className="d-flex mb-3 align-items-center rounded">
                                                <svg className="me-3 min-w50" width="50" height="50" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="d-flex mb-3 align-items-center rounded">
                                                <svg className="me-3 min-w50" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
